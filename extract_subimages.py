...
def main():
    ...
    # # LRx3 images
    # opt['input_folder'] = r'datasets/DL2K/DL2K_train_LR_bicubic/X3'
    # opt['save_folder'] = r'datasets/DL2K/DL2K_train_LR_bicubic/X3_sub'
    # opt['crop_size'] = 160
    # opt['step'] = 80
    # opt['thresh_size'] = 0
    # extract_subimages(opt)
    ...
    # # LRx4 images
    # opt['input_folder'] = r'datasets/DL2K/DL2K_train_LR_bicubic/X4'
    # opt['save_folder'] = r'datasets/DL2K/DL2K_train_LR_bicubic/X4_sub'
    # opt['crop_size'] = 120
    # opt['step'] = 60
    # opt['thresh_size'] = 0
    # extract_subimages(opt)
